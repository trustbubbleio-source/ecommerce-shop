...
const SECTIONS: PolicySection[] = [
  ...
  },
  {
    ...
    body: [
      `Contact us as soon as possible at ${SITE.email.orders} (or via the Contact page) with your order number if you need to cancel, change the delivery address, or amend line items.`,
  ...
  },
  {
    ...
    body: [
      `Email ${SITE.email.returns} with your order number, what you want to return, and whether it is a withdrawal, a fault, or a wrong item.`,
  ...
  },
  {
    ...
    body: [
      `If goods arrive damaged, incomplete, or not as described, contact ${SITE.email.returns} as soon as possible — ideally within 48 hours of delivery — with photos of the outer packaging and the product.`,
      ...
      `Missing items: email ${SITE.email.orders} your order number and a photo of what you received. We will ship the missing item or refund it after verification.`,
    ],
  },
  {
    id: 'liability',
    ...
    body: [
      ...
      `Carrier responsibility / in transit: once tracked dispatch has occurred, investigation of delay, loss or misrouting follows the carrier’s process. Contact ${SITE.email.orders} with your order number and tracking ID. We will open a claim where appropriate. If the parcel is confirmed lost or undeliverable due to carrier failure (and not due to your address error), we will re-ship or refund the goods. You are not automatically liable for all shipping risk merely because a parcel is late.`,
  ...
  },
  {
    ...
    body: [
      ...
      `Questions about a refund status: email ${SITE.email.billing} with your order number.`,
  ...
  },
  {
    ...
    body: [
      ...
      `Order status / missing items / tracking: ${SITE.email.orders}`,
      `Billing & refunds: ${SITE.email.billing}`,
